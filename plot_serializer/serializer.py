...
class Serializer:
    ...
    def convert_plot(self, p) -> Plot:
        if type(p) == matplotlib.pyplot.Figure:
            ...
            raise NotImplementedError("Only matplotlib is implemented. Make sure you submit a matplotlib.pyplot.Figure object.")
        return converted_plot

    def to_json(self) -> None:
        return json.loads(json.dumps(self.plot, default=lambda o: getattr(o, '__dict__', str(o))))
